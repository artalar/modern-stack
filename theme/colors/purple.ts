...
export const purple = defineSemanticTokens.colors({
	...
	'12': { value: { _light: '#3d2361', _dark: '#ecd9fa' } },
	a1: { value: { _light: '#aa00aa03', _dark: '#b412f90b' } },
	a2: { value: { _light: '#8000e008', _dark: '#b744f714' } },
	a3: { value: { _light: '#8e00f112', _dark: '#c150ff2d' } },
	a4: { value: { _light: '#8d00e51d', _dark: '#b94cff40' } },
	a5: { value: { _light: '#8000db2a', _dark: '#b952fd50' } },
	a6: { value: { _light: '#7a01d03b', _dark: '#bd5cfd60' } },
	a7: { value: { _light: '#6d00c350', _dark: '#c16dfd77' } },
	a8: { value: { _light: '#6600c06c', _dark: '#c27efda1' } },
	a9: { value: { _light: '#5500a2b1', _dark: '#b661ffc2' } },
	a10: { value: { _light: '#4d0096b8', _dark: '#bc6fffcd' } },
	a11: { value: { _light: '#4b0093ba', _dark: '#d19dff' } },
	a12: { value: { _light: '#180047dc', _dark: '#ecd9fa' } },
	solid: {
		bg: {
